...
function RowPost(props) {
  ...
  function trailer(id){
    ...
    console.log(id);
    axios.get(`${baseUrl}/movie/${id}/videos?api_key=${API_KEY}&language=en-US`).then((link)=>{
    ...
    <div>
      <div className='row'>
        ...
        <div className="moviecards">
          {
            movies.map((obj)=>
            <img onClick={()=>trailer(obj.id)} className='movies' src={`${image_url}${obj.poster_path}`} alt="" /> 
            )
          }
        </div>
      </div>
